   ...
   <head>
	...
	$(function(){
   	 ...
   	 $(".paginate_button a").click(function(e){
    		e.preventDefault();
    		$("#h_searchForm").find("input[name='pageNum']").val($(this).attr("href"));
    		$("#h_searchForm").attr({
    			"method":"get",
    			"action":"/adminOrders/helpList"
    		});
    		$("#h_searchForm").submit();
    	});
...
<div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h5 class="text-left m-0 font-weight-bold text-primary">취소/환불/교환</h5>
              ...
              <div class="card border-bottom-success shadow h-100 py-2">
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      <div class="h5 font-weight-bold text-primary text-uppercase mb-1 text-center">취소</div>
                      <div id="ready" class="h5 mb-0 font-weight-bold text-gray-800 text-center">${state.cancel}건</div>
                    </div>
                    <div class="col-auto">
            ...
            <div class="col-xl-4 col-md-6 mb-4">
              <div class="card border-bottom-primary shadow h-100 py-2">
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      <div class="h5 font-weight-bold text-primary text-uppercase mb-1 text-center">교환</div>
                      <div id="ing" class="h5 mb-0 font-weight-bold text-gray-800 text-center">${state.exchange}건</div>
                    </div>
                    <div class="col-auto">
            ...
            <div class="col-xl-4 col-md-6 mb-4">
              <div class="card border-bottom-danger shadow h-100 py-2">
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      <div class="h5 font-weight-bold text-primary text-uppercase mb-1 text-center">환불</div>
                      <div id="finish" class="h5 mb-0 font-weight-bold text-gray-800 text-center">${state.refund}건</div>
                    </div>
                    <div class="col-auto">
            ...
            <div class="col-lg-12">
              <div class="card shadow mb-4">
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                  <h6 class="m-0 font-weight-bold text-primary">/취소/환불/검색/ 검색</h6>
                </div>
                <!-- Card Body -->
                <div class="card-body">
                <form class="form-inline" id="h_searchForm">
                ...
                <div class="card-body">
                	<table class="table table-hover" >
                		...
                		<tr class="text-center">
                			...
                			<option value="교환신청" <c:if test="${orders.o_deliver=='교환신청'}">selected</c:if>>교환신청</option>
