   ...
   <head>
   	<title></title>
        ...
        <!-- 모바일 웹 페이지 설정 끝 -->
         ...
         var oneweek="${weekList.oneweek}";
         var twoweek="${weekList.twoweek}";
         var threeweek="${weekList.threeweek}";
         var fourweek="${weekList.fourweek}";
...
<div class="col-xl-6">
	...
	<a class="btn btn-success" href="/adminDetail/adminWeeksDetail" role="button">주별 매출</a>
	...
	<hr/>
            ...
            <div class="col-xl-12 col-lg-12">
              <div class="card shadow mb-4">
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                  <h6 class="m-0 font-weight-bold text-primary">주별 증감추이</h6>
                </div>
                <!-- Card Body -->
                <div class="card-body">
                	...
                	<colgroup>
                		...
                		<tr class="text-center">
                			<td>${week.startdate} ~
                			${week.enddate}</td>
                			<td class="text-center">${week.ordercnt}</td>
                			<td class="text-center">${week.stockcnt}</td>
                			<td class="text-center">${week.totalsell}</td>
                			<td class="text-center">${week.usepoint}</td>
                			
                			<td>${week.totalsum}</td>
                			<td>${week.totalrefund}</td>
                		</tr>
...
<script type="text/javascript" src="/resources/include/js/demo/chart-bar-week.js"></script>
</html>
